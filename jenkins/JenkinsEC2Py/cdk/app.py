...
ecs_cluster = ECSCluster(app, stack_name + 'ECS', vpc=network.vpc,
...
jenkins_leader_service = JenkinsLeader(app, stack_name + 'JenkinsLeader', cluster=ecs_cluster,
                                       vpc=network, worker=jenkins_workers)
